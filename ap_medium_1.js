...
function create_equation(a_1, d, n) {
    ...
    var a_k = a_1 + (k - 1) * d;     
    var s_n = (a_1 + a_n) * n / 2;
    return "Арифметическая прогрессия задана первым числом $a_1 = "+a_1+"$ и числом $a_n = "+a_n+",$ стоящем на месте номер $n = "+n+"$. Найдите элемент этой арифметической прогрессии, стоящий на месте $k = "+k+".$";
}
