...
function create_equation(b_1, q, n) {
    ...
    return "Геометрическая прогрессия задана первым числом $b_1 = "+b_1+"$, знаменателем $q = "+q+"$ и последним числом $b_n = "+b_n+"$. Найдите сумму элементов геометрической прогрессии.";
}
