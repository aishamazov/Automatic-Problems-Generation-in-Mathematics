...
function create_equation(a_1, d, n) {
    ...
    return "Арифметическая прогрессия задана числом $a_n = "+a_n+",$ стоящем на месте номер $n = "+n+"$, и суммой первых $"+n+"$ элементов $s_n = "+s_n+"$. Найдите первый элемент арифметической прогрессии.";
}
