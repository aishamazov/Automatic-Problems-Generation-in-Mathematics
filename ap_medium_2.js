...
function create_equation(a_1, d, n) {
    ...
    var a_k = a_1 + (k - 1) * d;     
    var s_n = (a_1 + a_n) * n / 2;
    return "Арифметическая прогрессия задана числом $a_n = "+a_n+",$ стоящем на месте номер $n = "+n+"$ и числом $a_k = "+a_k+",$ стоящем на месте номер $k = "+k+"$. Найдите первый элемент арифметической прогрессии.";
}
