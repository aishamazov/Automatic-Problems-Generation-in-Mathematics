...
function show_answer() {
    ...
    var s_n = b_1 * (1 - Math.pow(q, n)) / (1 - q);
...
function create_equation(b_1, q, n) {
    ...
    return "Геометрическая прогрессия задана знаменателем $q = "+q+"$, первым элементом $b_1 = "+b_1+"$ и суммой элементов $s_n = "+s_n+"$. Найдите последний элемент геометрической прогрессии.";
}
