...
function create_equation(a_1, d, n) {
    ...
    return "Арифметическая прогрессия задана числом $a_1 = "+a_1+"$ и суммой первых $"+n+"$ элементов $s_n = "+s_n+"$. Найдите элемент этой арифметической прогрессии, стоящий на месте $n = "+n+".$";
}
