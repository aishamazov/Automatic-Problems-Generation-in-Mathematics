...
function create_equation(b_1, q, n) {
    ...
    return "Геометрическая прогрессия задана знаменателем $q = "+q+"$, последним элементом $b_n = "+b_n+"$ и суммой элементов $s_n = "+s_n+"$. Найдите первый элемент геометрической прогрессии.";
}
